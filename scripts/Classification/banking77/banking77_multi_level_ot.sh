...
DATA_DIR="/mnt/hungpv/projects/MoEmb/dataset/data/banking77"
SAVE_DIR="${BASE_PATH}/outputs/eaadp_patent"
TEACHER_MODEL_PATH="/mnt/hungpv/projects/MoEmb/lora_path/llm2vec" 
# data
