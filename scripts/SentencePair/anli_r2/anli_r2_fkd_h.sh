...
TEACHER_MODEL_PATH="/mnt/hungpv/projects/MoEmb/lora_path/llm2vec/anli_r2/epoch2_step2842_loss0.2820"
NUM_LABELS=3
TASK="fkd_h"
...
FKD_H_LAMBDA=0.2     # Global-vs-contextual mix (lambda)
...
# Global assets live under SAVE_DIR
GLOBAL_DIR="${SAVE_DIR}"
mkdir -p "${GLOBAL_DIR}"
...
OPTS+=" --data-dir ${BASE_PATH}/dataset/data/anli_r2/"
OPTS+=" --num-workers 0"
OPTS+=" --dev-num 1000"
